...
public:
  ...
  static constexpr size_t width = order + 1;
...
//      return fd_stencils<order>::stencil[dpoint][N] * grid_ptr[(N-dpoint)*stride]
...
//      return fd_stencils<order>::stencil[dpoint][0] * grid_ptr[(0-dpoint)*stride];
    }
  };
