...
class tensor_trace_t : public tensor_expression_t<tensor_trace_t<i1,i2,E> > {
  ...
  public:
    ...
    struct recursive_component_trace {
      template<typename A>
      static inline typename E::property_t::data_t const trace(A const & _u) {
...
struct scalar_trace_recursion {
  static inline typename E::property_t::data_t const trace(E const &u) {
...
struct tracer_t {
  static inline tensor_trace_t<(i1 < i2) ? i1 : i2,(i1 > i2) ? i1 : i2,E> const trace(E const &u) {
