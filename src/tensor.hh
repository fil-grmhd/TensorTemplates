...
class general_tensor_t : public tensor_expression_t<general_tensor_t<T, frame_t_,rank_ , index_t_, ndim_>> {
  ...
  public:
    ...
    //! Generates components from arbitrary tensor expression type (e.g. chained ones)

    // This is not a copy constructor, leading to (hopefully optimal) default copy and move constructors
    // C++14 way to completely get around the for loop to initialize component array
