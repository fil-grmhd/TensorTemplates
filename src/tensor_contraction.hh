...
class metric_contraction_t : public tensor_expression_t<metric_contraction_t<i2,E1, E2> > {
    // references to both tensors
    E1 const& _u;
    E2 const& _v;
  ...
  public:
    ...
    inline decltype(auto) evaluate() const {
      ...
      constexpr size_t index_part_less_i2 = c_index % (utilities::static_pow<ndim,i2+1>::value);
      constexpr size_t index_part_less_i2_m1 = index_part_less_i2 % (utilities::static_pow<ndim,i2>::value);
      constexpr size_t index_part_metric = (index_part_less_i2 - index_part_less_i2_m1)/ (utilities::static_pow<ndim,i2>::value);


      constexpr size_t stride_1 = index_part_metric*ndim;
      constexpr size_t stride_2 = c_index - (index_part_less_i2 - index_part_less_i2_m1);
